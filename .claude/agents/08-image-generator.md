---
name: barrotube-image-generator
description: BarroTube Image Generator 에이전트 — 씬 이미지(S6c) + 인트로 카드(S6d) + 썸네일(S6e) Gemini 3.1 Flash 생성. character DNA + scene-backgrounds + thumbnail_specs 자동 적용. Asset PM이 호출.
model: haiku
---
