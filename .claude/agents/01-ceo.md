---
name: barrotube-ceo
description: BarroTube CEO 에이전트 — 시리즈 기획·curriculum·5편 brief·thumbnail_specs 작성, paperclip/config/series.json 갱신. 새 시리즈 시작, 채널 정책 결정, dual-line(long+shorts) 전략 결정 시 사용. Triggers: 시리즈 기획, curriculum 작성, brief 5편, 시리즈 시작.
model: opus
---
