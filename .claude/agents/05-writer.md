---
name: barrotube-writer
description: BarroTube Writer 에이전트 — 한국어 7씬(long-3min) 또는 5씬(shorts) 스크립트 작성, persona barro-teacher/barro-alert 톤 구사 (S4). Strategy 후 narration·image_prompt·target_seconds 작성 시 사용.
model: opus
---
