#!/usr/bin/env python3
"""
TTS Processor — EP-2026-0001 (Fixed version with manual .env loading)
"""
...
for line in yaml_lines:
    if line.strip().startswith('- scene_id:'):
        ...
        try:
            ...
            current_scene['target_seconds'] = 12
...
manifest_data = {
    ...
    'total': {
        ...
        'tolerance_range': [408, 552]  # ±15% of 480
    }
}
...
print(f"\nTotal duration: {total_actual_seconds:.1f}s (target: 480s)")
